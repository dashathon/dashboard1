...
import { Satisfaction } from "src/models/enums/Satisfaction";
//#endregion 
...
//#endregion
    ...
    getSatisfaction(pSatisfaction: number): Satisfaction{
        switch(pSatisfaction){
   ...
   insertTeamProcess() : void{
    this.teamProcess.SatisfactionWithProcess.Efficiency.push(this.getSatisfaction(this.getRandomInt(5)));
    this.teamProcess.SatisfactionWithProcess.Coordination.push(this.getSatisfaction(this.getRandomInt(5)));
    this.teamProcess.SatisfactionWithProcess.Fairness.push(this.getSatisfaction(this.getRandomInt(5)));
    this.teamProcess.SatisfactionWithProcess.Clarity.push(this.getSatisfaction(this.getRandomInt(5)));
